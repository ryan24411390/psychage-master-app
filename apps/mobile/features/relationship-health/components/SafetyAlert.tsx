  ...
  return (
    ...
    >
      ...
      <View className="flex-1">
        <Text variant="h6" className="text-[14px]">
          {title}
        </Text>
    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onDismiss}>
      ...
      <View className="flex-1 items-center justify-center bg-black/60 px-6">
        <View className="w-full max-w-md rounded-2xl border border-border bg-surface p-5 dark:border-border-dark dark:bg-surface-dark">
          <Text variant="h3" className="mb-2" accessibilityRole="header">
            {t.title}
          </Text>
          <Text variant="bodySmall" className="mb-4 text-text-secondary dark:text-text-secondary-dark leading-5">
            {t.body}
          </Text>
