...
function Row({
  ...
  return (
    ...
    >
      <Text variant={emphasis ? 'h6' : 'body'}>{label}</Text>
...
export function LocationSetup() {
      ...
      <View className="flex-1 bg-background dark:bg-background-dark px-4 pt-2">
        ...
        <View className="mt-5 rounded-xl bg-surface-accent p-4 dark:bg-surface-accent-dark">
          <View className="flex-row items-center gap-2">
            ...
            <Text variant="h6">{t.outsideCrisisTitle}</Text>
          </View>
          <Text variant="bodySmall" className="mt-1.5 text-text-secondary dark:text-text-secondary-dark">
            {t.outsideCrisisBody}
          </Text>
          <View className="mt-3">
  ...
  return (
    <View className="flex-1 bg-background dark:bg-background-dark px-4 pt-2">
      <Text variant="h2">{t.setupStateTitle}</Text>
      <Text variant="body" className="mt-2 text-text-secondary dark:text-text-secondary-dark">
        {t.setupStateBody}
      </Text>
