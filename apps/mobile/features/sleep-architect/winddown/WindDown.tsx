  ...
  return (
    <View className="gap-4">
      ...
      <Card className="gap-2 px-4 py-4">
        <Text variant="h5">{t.breathingTitle}</Text>
        <Text variant="bodySmall" className="text-text-secondary dark:text-text-secondary-dark">
          {t.breathingBody}
        </Text>
        <Button
      ...
      <Card className="gap-2 px-4 py-4">
        <Text variant="h5">{t.brainDumpTitle}</Text>
        <Text variant="bodySmall" className="text-text-secondary dark:text-text-secondary-dark">
          {t.brainDumpBody}
        </Text>
        <TextInput
        ...
        {crisisFlagged ? (
          <View className="gap-2 rounded-lg border border-crisis px-3 py-2">
            <Text variant="bodySmall">{t.crisisLine}</Text>
            <CrisisPill />
          </View>
        ) : null}
        {brainDump.length > 0 ? (
      ...
      {CT4_SLEEP.cbtiCards.map((card) => (
        <Card key={card.id} className="gap-1 px-4 py-4">
          ...
          <Text variant="bodySmall" className="leading-5 text-text-secondary dark:text-text-secondary-dark">
            {card.body}
          </Text>
        </Card>
      ))}
