      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} className="-mx-5" contentContainerClassName="px-5 gap-3">
        {reads.map((r) => (
          <Pressable
            ...
            className="w-56 h-32 rounded-xl overflow-hidden bg-surface dark:bg-surface-dark shadow-sm border border-border/40 dark:border-border-dark/40 active:scale-[0.98]"
          >
