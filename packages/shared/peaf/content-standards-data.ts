...
import type { ArticleType, SourceTier } from "./types";
...
export const qualityChecks: QualityCheck[] = [
  {
    name: "Peer-Reviewed Minimum",
    description: `At least ${QUALITY_GATE.MIN_TIER1_PCT}% of citations must come from peer-reviewed journals`,
    blocking: true,
  },
  {
    name: "Evidence Base",
    description: `Combined Tier 1 + 2 sources must reach ${QUALITY_GATE.MIN_TIER1_2_PCT}%`,
    blocking: true,
  },
  {
    name: "Reference Cap",
    description: `Educational and reference sources limited to ${QUALITY_GATE.MAX_TIER5_PCT}% maximum`,
    blocking: true,
  },
  {
    name: "Citation Count",
    description: "Each article must cite between 5 and 12 sources depending on type",
    blocking: true,
  },
  {
    name: "Recency",
    description: `At least ${QUALITY_GATE.MIN_RECENT_PCT}% of sources published within the last ${QUALITY_GATE.RECENCY_YEARS} years`,
    blocking: false,
  },
  {
    name: "Required Sections",
    description: "Every article must include all sections required by its type",
    blocking: true,
  },
  {
    name: "Readability",
    description: `Written at or below an 8th-grade reading level so anyone can understand it`,
    blocking: true,
  },
  {
    name: "Medical Disclaimer",
    description: "Articles about conditions and treatments must include a medical disclaimer",
    blocking: true,
  },
  {
    name: "Author Attribution",
    description: "Every article must have an attributed author with credentials",
    blocking: true,
  },
  {
    name: "Inclusive Language",
    description: "Flagged terms are replaced with person-first, strength-based alternatives",
    blocking: false,
  },
  {
    name: "Blocked Sources",
    description: "Prevents citations from unreliable or ad-supported health sites",
    blocking: true,
  },
];
...
export const articleTypeCards: ArticleTypeCard[] = (
  Object.keys(ARTICLE_TEMPLATES) as ArticleType[]
).map((key) => {
...
export const reviewSteps = [
  ...
  {
    label: "Quality Gate",
    description: "Automated 11-point check validates sources, readability, and structure",
  },
  {
    label: "Editorial Review",
    description: "Editor reviews for accuracy, tone, and inclusive language",
  },
  {
    label: "Clinical Review",
    description: "For sensitive topics, a clinical reviewer verifies medical accuracy",
  },
  {
    label: "Published",
    description: "Article goes live with full citations and medical disclaimers",
  },
];
