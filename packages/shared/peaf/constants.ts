...
> = {
  1: {
    ...
    color: "amber",
    description: "Peer-reviewed journals, meta-analyses, systematic reviews",
  },
  2: {
    label: "Government / Institutional",
    color: "blue",
    description: "NIMH, NIH, WHO, CDC, SAMHSA",
  },
  3: {
    label: "Professional Organizations",
    color: "teal",
    description: "APA (Psychiatric/Psychological), NAMI, MHA",
  },
  4: {
    label: "Clinical Guidelines",
    color: "purple",
    description: "DSM-5-TR, ICD-11, Cochrane, practice guidelines",
  },
  5: {
    label: "Educational / Reference",
    color: "gray",
    description: "Mayo Clinic, textbooks, reference works",
  },
};
...
export const EXPANDED_SOURCE_TYPES: {
  label: string;
  value: ExpandedSourceType;
  tier: SourceTier;
}[] = [
  // Tier 1
...
export const ARTICLE_TEMPLATES: Record<ArticleType, ArticleTemplate> = {
  condition_deep_dive: {
    ...
    description:
      "Comprehensive guide to a mental health condition — symptoms, causes, diagnosis, treatment, and daily living.",
    requiredSections: [
      "Overview",
      "Signs & Symptoms",
      "Causes & Risk Factors",
  ...
  treatment_guide: {
    ...
    description:
      "Evidence-based explanation of a treatment modality — how it works, effectiveness data, and what to expect.",
    requiredSections: [
      "What Is",
      "How It Works",
      "What to Expect",
  ...
  research_digest: {
    ...
    description:
      "Plain-language breakdown of a recent study — key finding, methodology, implications, and limitations.",
    requiredSections: [
      "Key Finding",
      "Study Details",
      "What This Means",
  ...
  self_help: {
    ...
    description:
      "Actionable, evidence-backed strategies for managing symptoms or improving wellbeing.",
    requiredSections: [
  ...
  crisis_safety: {
    ...
    label: "Crisis & Safety",
    description:
      "Urgent mental health content — recognizing crises, immediate steps, hotlines, and safety planning.",
    requiredSections: [
...
export const ARTICLE_TYPE_OPTIONS: { label: string; value: ArticleType; description: string }[] =
  Object.values(ARTICLE_TEMPLATES).map((t) => ({
    label: t.label,
    value: t.type,
