import type { ConditionWithMappings, KnowledgeBase, Symptom } from "../types";
...
const symptoms: Symptom[] = [
  // ── Mood (MOD_001–MOD_009) ───────────────────────────────────────────────
  {
    ...
    description: "A continuous feeling of sadness or emptiness that lasts most of the day.",
    synonyms: ["sad", "depressed", "down", "blue"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Diminished interest in activities previously enjoyed.",
    synonyms: ["anhedonia", "bored", "apathy", "no motivation"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Pervasive sense of being inadequate or without value.",
    synonyms: ["worthless", "useless", "no good", "failure"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Disproportionate guilt about minor or imagined issues.",
    synonyms: ["guilty", "blame", "at fault", "regret"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "mood",
    name: "Hopelessness",
    description: "Feeling that nothing will improve and the future is bleak.",
    synonyms: ["hopeless", "no future", "give up", "pointless"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "mood",
    name: "Elevated or euphoric mood",
    description: "Abnormally high energy or elation disproportionate to circumstances.",
    synonyms: ["manic", "euphoric", "on top of the world", "high"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "mood",
    name: "Irritability",
    description: "Increased tendency to become frustrated or angry easily.",
    synonyms: ["irritable", "angry", "short fuse", "snappy"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "mood",
    name: "Mood swings",
    description: "Rapid, unpredictable shifts in emotional state.",
    synonyms: ["mood changes", "unstable mood", "emotional rollercoaster"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Feeling emotionally flat or disconnected from feelings.",
    synonyms: ["numb", "empty", "flat", "detached"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Anxiety/Fear (ANX_001–ANX_010) ───────────────────────────────────────
  {
    ...
    description: "Uncontrollable worry about multiple areas of life.",
    synonyms: ["worry", "anxious", "nervous", "stressed"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    synonyms: ["panic", "heart racing", "can't breathe", "terror"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Intense fear triggered by particular objects or situations.",
    synonyms: ["phobia", "scared", "afraid", "avoid"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "anxiety_fear",
    name: "Social anxiety",
    description: "Marked fear or anxiety about social situations and being judged.",
    synonyms: ["shy", "social fear", "embarrassment", "stage fright"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "anxiety_fear",
    name: "Restlessness or feeling on edge",
    description: "Unable to relax, feeling keyed up or tense.",
    synonyms: ["restless", "on edge", "tense", "can't relax"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "anxiety_fear",
    name: "Muscle tension",
    description: "Persistent tightness or stiffness in muscles due to anxiety.",
    synonyms: ["tense", "tight muscles", "stiff", "clenching"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "anxiety_fear",
    name: "Dread or sense of impending doom",
    description: "Persistent feeling that something terrible is about to happen.",
    synonyms: ["doom", "dread", "bad feeling", "foreboding"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "anxiety_fear",
    name: "Avoidance of feared situations",
    description: "Actively staying away from places, people, or activities that trigger fear.",
    synonyms: ["avoidance", "staying away", "won't go", "escape"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "anxiety_fear",
    name: "Fear of losing control or going crazy",
    description: "Persistent fear of losing mental control or sanity.",
    synonyms: ["losing it", "going crazy", "losing mind", "unhinged"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "anxiety_fear",
    name: "Excessive health anxiety",
    description: "Persistent preoccupation with having or acquiring a serious illness.",
    synonyms: ["hypochondria", "health worry", "illness anxiety", "medical fear"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Emotional Regulation (EMR_001–EMR_006) ───────────────────────────────
  {
    ...
    description: "Sudden intense emotional reactions that feel disproportionate.",
    synonyms: ["outbursts", "tantrums", "explosive", "overreact"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "emotional_regulation",
    name: "Difficulty managing anger",
    description: "Trouble controlling angry responses to frustration.",
    synonyms: ["anger issues", "rage", "fury", "hostile"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "emotional_regulation",
    name: "Crying spells",
    description: "Frequent episodes of crying that may seem unprovoked.",
    synonyms: ["crying", "tearful", "weepy", "can't stop crying"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "emotional_regulation",
    name: "Intense fear of abandonment",
    description: "Overwhelming anxiety about being left or rejected by others.",
    synonyms: ["abandonment", "clingy", "left alone", "rejected"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Feeling disconnected from your own emotions or from other people.",
    synonyms: ["detached", "disconnected", "numb", "removed"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "emotional_regulation",
    name: "Persistent grief or mourning",
    description: "Prolonged grief that significantly impairs daily functioning.",
    synonyms: ["grief", "mourning", "loss", "bereavement"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Body Sensations (BDY_001–BDY_010) ────────────────────────────────────
  {
    ...
    name: "Headaches",
    description: "Recurring headaches without clear medical cause.",
    synonyms: ["head pain", "migraine", "head pressure"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "body_sensations",
    name: "Stomach or digestive issues",
    description: "Frequent nausea, stomach pain, or digestive discomfort.",
    synonyms: ["nausea", "stomach ache", "GI issues", "upset stomach"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Heart racing or pounding without physical exertion.",
    synonyms: ["palpitations", "heart pounding", "racing heart"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Difficulty breathing not caused by physical activity.",
    synonyms: ["can't breathe", "breathless", "gasping"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Feeling faint, unsteady, or like the room is spinning.",
    synonyms: ["dizzy", "faint", "lightheaded", "vertigo"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Chronic pain without identifiable medical cause.",
    synonyms: ["chronic pain", "body aches", "hurting"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Involuntary shaking or trembling of hands or body.",
    synonyms: ["shaking", "trembling", "tremors", "shivering"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "body_sensations",
    name: "Sweating excessively",
    description: "Sweating more than usual without heat or exercise.",
    synonyms: ["sweating", "clammy", "sweaty palms"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Physical sensations of numbness or pins and needles.",
    synonyms: ["tingling", "pins and needles", "numb hands"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Noticeable slowing down or agitation in physical movements.",
    synonyms: ["slowed down", "agitated", "restless body", "fidgety"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Sleep (SLP_001–SLP_005) ──────────────────────────────────────────────
  {
    ...
    synonyms: ["insomnia", "can't sleep", "lying awake"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "sleep",
    name: "Waking up frequently",
    description: "Repeatedly waking during the night.",
    synonyms: ["night waking", "broken sleep", "restless nights"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Sleeping significantly more than usual.",
    synonyms: ["hypersomnia", "oversleeping", "always tired"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "sleep",
    name: "Nightmares or disturbing dreams",
    description: "Recurring distressing dreams that disrupt sleep quality.",
    synonyms: ["nightmares", "bad dreams", "night terrors"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Feeling rested after very little sleep without being tired.",
    synonyms: ["no sleep needed", "energized", "few hours"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Appetite/Weight (APT_001–APT_004) ────────────────────────────────────
  {
    ...
    description: "Significant reduction in desire to eat.",
    synonyms: ["not hungry", "no appetite", "skipping meals"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "appetite_weight",
    name: "Increased appetite or cravings",
    description: "Eating more than usual or craving specific foods.",
    synonyms: ["overeating", "cravings", "binge eating", "always hungry"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "appetite_weight",
    name: "Unintentional weight change",
    description: "Significant weight gain or loss without trying.",
    synonyms: ["weight gain", "weight loss", "body change"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Deliberately limiting food intake in unhealthy ways.",
    synonyms: ["dieting", "restricting", "not eating", "food rules"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Energy (ENR_001–ENR_006) ─────────────────────────────────────────────
  {
    ...
    synonyms: ["tired", "exhausted", "drained", "no energy"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "energy",
    name: "Excessive energy or hyperactivity",
    description: "Unusually high energy that feels hard to contain.",
    synonyms: ["hyperactive", "wired", "can't sit still", "buzzing"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "energy",
    name: "Feeling physically heavy",
    description: "Limbs feel weighted or heavy, making movement effortful.",
    synonyms: ["heavy", "leaden", "weighed down"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "energy",
    name: "Easily fatigued by minor tasks",
    description: "Becoming exhausted from activities that used to be easy.",
    synonyms: ["tired quickly", "low stamina", "winded easily"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Getting less done at work, school, or home than usual.",
    synonyms: ["unproductive", "slacking", "falling behind"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "energy",
    name: "Seasonal energy changes",
    description: "Energy levels that notably change with seasons.",
    synonyms: ["winter fatigue", "seasonal", "low in winter"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Cognition (COG_001–COG_011) ──────────────────────────────────────────
  {
    ...
    description: "Trouble focusing or sustaining attention on tasks.",
    synonyms: ["can't focus", "distracted", "brain fog"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    synonyms: ["can't decide", "paralyzed", "overthinking choices"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Thoughts moving so fast they are hard to track.",
    synonyms: ["racing mind", "fast thoughts", "can't slow down"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    synonyms: ["forgetful", "memory loss", "can't remember"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Unwanted distressing thoughts that are hard to dismiss.",
    synonyms: ["unwanted thoughts", "disturbing thoughts", "obsessions"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "cognition",
    name: "Rumination",
    description: "Repetitively going over the same negative thoughts.",
    synonyms: ["overthinking", "dwelling", "can't let go", "looping"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "cognition",
    name: "Flashbacks",
    description: "Vivid re-experiencing of past traumatic events.",
    synonyms: ["reliving", "flashback", "trauma memory", "triggered"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Thoughts about hurting yourself intentionally.",
    synonyms: ["self-harm", "cutting", "hurting myself"],
    ask_duration: false,
    ask_severity: false,
    ask_frequency: false,
    is_red_flag: true,
  ...
  },
  {
    ...
    description: "Thoughts about ending your own life.",
    synonyms: ["suicide", "ending it", "not wanting to live"],
    ask_duration: false,
    ask_severity: false,
    ask_frequency: false,
    is_red_flag: true,
  ...
  },
  {
    ...
    description: "Thoughts about hurting other people.",
    synonyms: ["violent thoughts", "harming others", "homicidal"],
    ask_duration: false,
    ask_severity: false,
    ask_frequency: false,
    is_red_flag: true,
  ...
  },
  {
    ...
    description: "Persistent unfounded suspicion that others intend harm.",
    synonyms: ["paranoid", "suspicious", "distrust", "conspiracy"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Perception (PRC_001–PRC_007) ─────────────────────────────────────────
  {
    ...
    category: "perception",
    name: "Hypervigilance",
    description: "Being excessively alert and scanning for threats.",
    synonyms: ["on guard", "hyperaware", "scanning", "startle"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "cognitive",
    category: "perception",
    name: "Feeling unreal or dreamlike",
    description: "Sense that yourself or the world is not real.",
    synonyms: ["derealization", "depersonalization", "dreamlike", "unreal"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Perceiving your body or appearance inaccurately.",
    synonyms: ["body dysmorphia", "ugly", "fat", "distorted"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "perception",
    name: "Hallucinations",
    description: "Seeing, hearing, or sensing things that are not there.",
    synonyms: ["hearing voices", "seeing things", "hallucinating"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: true,
  ...
  },
  {
    ...
    domain: "cognitive",
    category: "perception",
    name: "Heightened sensitivity to stimuli",
    description: "Over-responsiveness to sound, light, touch, or smell.",
    synonyms: ["sensitive", "overstimulated", "sensory overload"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Thoughts that are jumbled, fragmented, or hard to follow.",
    synonyms: ["confused", "scattered", "incoherent", "tangential"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "perception",
    name: "Delusions",
    description: "Fixed false beliefs held despite contrary evidence.",
    synonyms: ["delusional", "false beliefs", "grandiose", "persecutory"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: true,
  ...
  // ── Social (SOC_001–SOC_008) ─────────────────────────────────────────────
  {
    ...
    description: "Pulling away from friends, family, and social activities.",
    synonyms: ["isolating", "withdrawing", "hermit", "alone"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    synonyms: ["fighting", "conflict", "relationship problems"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Persistent suspicion of others' intentions.",
    synonyms: ["distrust", "suspicious", "guarded", "wary"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Persistent sense that others do not understand you.",
    synonyms: ["misunderstood", "different", "outsider", "alienated"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "social",
    name: "Difficulty reading social cues",
    description: "Trouble interpreting facial expressions, tone, or body language.",
    synonyms: ["social cues", "body language", "misread", "awkward"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "social",
    name: "People-pleasing or over-accommodation",
    description: "Consistently prioritizing others' needs at cost to your own.",
    synonyms: ["people pleaser", "doormat", "can't say no"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Pattern of intense but volatile interpersonal relationships.",
    synonyms: ["on and off", "love-hate", "stormy relationships"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "social",
    name: "Extreme sensitivity to rejection",
    description: "Disproportionate distress when facing perceived rejection.",
    synonyms: ["rejection sensitive", "can't handle rejection", "hurt easily"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Coping (CPG_001–CPG_012) ─────────────────────────────────────────────
  {
    ...
    description: "Using alcohol or drugs to manage difficult emotions.",
    synonyms: ["drinking", "drugs", "self-medicating", "numbing"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Repetitive actions performed to reduce anxiety.",
    synonyms: ["rituals", "checking", "counting", "washing"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    category: "coping",
    name: "Binge eating",
    description: "Eating large amounts of food in a short time with loss of control.",
    synonyms: ["bingeing", "overeating", "loss of control eating"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Intentionally injuring yourself as a coping mechanism.",
    synonyms: ["cutting", "burning", "self-injury", "hurting self"],
    ask_duration: false,
    ask_severity: false,
    ask_frequency: false,
    is_red_flag: true,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "coping",
    name: "Excessive reassurance-seeking",
    description: "Repeatedly seeking reassurance from others about worries.",
    synonyms: ["reassurance", "checking with others", "needing validation"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "coping",
    name: "Procrastination or avoidance",
    description: "Consistently putting off tasks or responsibilities.",
    synonyms: ["procrastinating", "putting off", "avoiding tasks"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Eating in response to emotions rather than hunger.",
    synonyms: ["comfort eating", "stress eating", "eating feelings"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "coping",
    name: "Excessive screen time or gaming",
    description: "Using screens or games excessively to escape distress.",
    synonyms: ["gaming addiction", "doomscrolling", "screen addiction"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description:
      "Self-induced vomiting, laxative misuse, or excessive exercise to compensate for eating.",
    synonyms: ["vomiting", "purging", "laxatives", "compensating"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "coping",
    name: "Hoarding or difficulty discarding",
    description: "Persistent difficulty getting rid of possessions regardless of value.",
    synonyms: ["hoarding", "collecting", "can't throw away"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "coping",
    name: "Skin picking or hair pulling",
    description: "Repetitive body-focused behaviors causing tissue damage.",
    synonyms: ["picking", "hair pulling", "trichotillomania", "dermatillomania"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "coping",
    name: "Compulsive checking of body",
    description: "Repeatedly examining body for perceived flaws or illness signs.",
    synonyms: ["mirror checking", "body checking", "symptom checking"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Activity Level (ACT_001–ACT_008) ─────────────────────────────────────
  {
    ...
    description: "Failing to keep up with work, school, or home duties.",
    synonyms: ["neglecting", "slipping", "not caring", "dropping the ball"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "activity_level",
    name: "Impulsive behaviors",
    description: "Acting without thinking about consequences.",
    synonyms: ["impulsive", "reckless", "spontaneous", "hasty"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "activity_level",
    name: "Risky or reckless behavior",
    description: "Engaging in dangerous activities without regard for safety.",
    synonyms: ["reckless", "risky", "dangerous", "thrill-seeking"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "activity_level",
    name: "Excessive goal-directed activity",
    description: "Intense focus on projects, often unrealistic, for extended periods.",
    synonyms: ["overworking", "driven", "obsessed with goals"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Spending money impulsively without regard for consequences.",
    synonyms: ["overspending", "shopping spree", "spending spree"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "activity_level",
    name: "Decreased self-care",
    description: "Neglecting personal hygiene, grooming, or health routines.",
    synonyms: ["not showering", "messy", "letting go", "neglect self"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "activity_level",
    name: "Repetitive or stereotyped movements",
    description: "Recurring motor movements such as rocking, hand-flapping, or spinning.",
    synonyms: ["stimming", "rocking", "hand flapping", "spinning"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "behavioral",
    category: "activity_level",
    name: "Rigid adherence to routines",
    description: "Extreme distress when routines or rituals are disrupted.",
    synonyms: ["routine", "rigid", "inflexible", "need sameness"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Identity/Self-Image (IDN_001–IDN_004) [NEW] ─────────────────────────
  {
    ...
    name: "Unstable sense of self",
    description: "Frequently shifting goals, values, or sense of identity.",
    synonyms: ["identity crisis", "don't know who I am", "changing self"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    description: "Persistent inner void or hollowness.",
    synonyms: ["empty", "hollow", "void", "nothing inside"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "identity_self_image",
    name: "Excessive self-consciousness",
    description: "Intense preoccupation with how others perceive you.",
    synonyms: ["self-conscious", "embarrassed", "judged", "watched"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "emotional",
    category: "identity_self_image",
    name: "Grandiosity or inflated self-importance",
    description: "Unrealistic sense of superiority or special abilities.",
    synonyms: ["grandiose", "superior", "special", "above others"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  // ── Somatic/Health (SOM_001–SOM_003) [NEW] ──────────────────────────────
  {
    ...
    name: "Preoccupation with physical symptoms",
    description: "Excessive focus on bodily symptoms and their significance.",
    synonyms: ["body focus", "symptom worry", "health obsession"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "somatic_health",
    name: "Conversion symptoms",
    description: "Neurological symptoms like weakness or seizures without medical cause.",
    synonyms: ["weakness", "seizure-like", "paralysis", "loss of function"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
  ...
  },
  {
    ...
    domain: "physical",
    category: "somatic_health",
    name: "Cyclical mood-body symptoms",
    description: "Mood and physical symptoms that follow a predictable cycle.",
    synonyms: ["PMS", "cyclical", "monthly pattern", "hormonal mood"],
    ask_duration: true,
    ask_severity: true,
    ask_frequency: true,
    is_red_flag: false,
...
const conditions: ConditionWithMappings[] = [
  // 1. MDE — Major Depressive Episode
  {
    ...
    description_for_user:
      "A pattern of persistent low mood, reduced energy, and diminished interest that some people experience. These experiences may be related to what mental health professionals call a major depressive episode.",
    ...
    clinical_notes: "Based on DSM-5 criteria for Major Depressive Disorder (296.xx).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 2. PDD — Persistent Depressive Disorder
  {
    ...
    category: "mood",
    description_for_user:
      "A pattern of chronically low mood lasting for an extended period. While less intense than acute depression, this persistent experience can significantly impact daily life.",
    ...
    clinical_notes: "Based on DSM-5 criteria for Persistent Depressive Disorder (300.4).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "MOD_001", weight: 3, role: "core" },
  ...
  // 3. GAD — Generalized Anxiety Disorder
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for GAD (300.02).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 4. PD — Panic Disorder
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for Panic Disorder (300.01).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 5. SAD — Social Anxiety Disorder
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for Social Anxiety Disorder (300.23).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 6. PTSD — Post-Traumatic Stress Disorder
  {
    ...
    category: "trauma",
    description_for_user:
      "A pattern of re-experiencing, avoidance, and heightened alertness that can develop after exposure to traumatic events.",
    minimum_duration: "1_month",
    minimum_duration_display: "At least 1 month",
    minimum_symptoms_for_relevance: 4,
    always_recommend_professional: true,
    ...
    clinical_notes: "Based on DSM-5 criteria for PTSD (309.81).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 7. OCD — Obsessive-Compulsive Disorder
  {
    ...
    description_for_user:
      "A pattern of unwanted, intrusive thoughts (obsessions) and repetitive behaviors or mental acts (compulsions) performed to reduce distress.",
    minimum_duration: "2_weeks",
    minimum_duration_display: "At least 2 weeks",
    ...
    clinical_notes: "Based on DSM-5 criteria for OCD (300.3).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "COG_005", weight: 3, role: "core" },
  ...
  // 8. BIP — Bipolar Disorder
  {
    ...
    category: "mood",
    description_for_user:
      "A pattern involving significant shifts in mood, energy, and activity levels — including periods of unusually elevated mood and periods of depression.",
    ...
    clinical_notes: "Based on DSM-5 criteria for Bipolar I/II Disorder (296.xx).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 9. ADHD — Attention-Deficit/Hyperactivity Disorder
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for ADHD (314.0x).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 10. BUR — Burnout Syndrome
  {
    ...
    clinical_notes: "Based on ICD-11 definition of Burnout (QD85).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "ENR_001", weight: 3, role: "core" },
  ...
  // 11. INS — Insomnia Disorder
  {
    ...
    category: "sleep",
    description_for_user:
      "Persistent difficulty with falling asleep, staying asleep, or experiencing unrefreshing sleep despite adequate opportunity.",
    minimum_duration: "3_months",
    minimum_duration_display: "At least 3 months",
    minimum_symptoms_for_relevance: 2,
    always_recommend_professional: false,
    ...
    clinical_notes: "Based on DSM-5 criteria for Insomnia Disorder (780.52).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "SLP_001", weight: 3, role: "core" },
  ...
  // 12. BED — Binge Eating Disorder
  {
    ...
    category: "eating",
    description_for_user:
      "Recurring episodes of eating significantly more food than most people would, accompanied by a feeling of loss of control.",
    minimum_duration: "3_months",
    minimum_duration_display: "At least 3 months",
    minimum_symptoms_for_relevance: 3,
    always_recommend_professional: false,
    ...
    clinical_notes: "Based on DSM-5 criteria for Binge Eating Disorder (307.51).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 13. AN — Anorexia Nervosa
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for Anorexia Nervosa (307.1).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 14. SUD — Substance Use Concern
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for Substance Use Disorders.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 15. AGO — Agoraphobia
  {
    ...
    category: "anxiety",
    description_for_user:
      "Intense anxiety about situations where escape might be difficult or help unavailable.",
    minimum_duration: "6_months",
    minimum_duration_display: "At least 6 months",
    minimum_symptoms_for_relevance: 2,
    always_recommend_professional: false,
    ...
    clinical_notes: "Based on DSM-5 criteria for Agoraphobia (300.22).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
  ...
  // 16. ADJ — Adjustment Disorder
  {
    ...
    clinical_notes: "Based on DSM-5 criteria for Adjustment Disorders (309.x).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "ANX_008", weight: 3, role: "core" },
  ...
  // 17. SCZ — Schizophrenia Spectrum
  {
    ...
    category: "psychotic",
    description_for_user:
      "Psychotic experiences may include hearing or seeing things others do not, holding beliefs that seem unusual to others, or having difficulty organizing thoughts.",
    minimum_duration: "1_month",
    minimum_duration_display: "At least 1 month",
    minimum_symptoms_for_relevance: 3,
    always_recommend_professional: true,
  ...
  {
    id: "CYC",
    name: "Cyclothymic Mood Pattern",
    full_name: "Cyclothymic Disorder",
    category: "mood",
    description_for_user:
      "A pattern of chronic mood fluctuations between periods of mild depression and mild elevation. While less intense than bipolar disorder, these ongoing shifts can affect daily life and relationships.",
    minimum_duration: "2_years",
    minimum_duration_display: "At least 2 years",
    minimum_symptoms_for_relevance: 3,
    always_recommend_professional: false,
    guide_path: "/learn/conditions/cyclothymia",
    coping_path: "/learn/coping/mood-stability",
    provider_questions: [
      "Could my mood ups and downs be cyclothymia?",
      "How is cyclothymic disorder different from bipolar disorder?",
      "What treatments help stabilize mood fluctuations?",
    ],
    clinical_notes: "Based on DSM-5-TR criteria for Cyclothymic Disorder (301.13). ICD-11 6A62.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "MOD_008", weight: 3, role: "core" },
      { symptom_id: "MOD_006", weight: 3, role: "core" },
      { symptom_id: "ENR_002", weight: 3, role: "core" },
      { symptom_id: "MOD_001", weight: 2, role: "common" },
      { symptom_id: "SLP_001", weight: 2, role: "common" },
      { symptom_id: "SLP_003", weight: 2, role: "common" },
      { symptom_id: "COG_003", weight: 2, role: "common" },
  ...
  // 33. PPD_M — Peripartum/Postpartum Depression
  {
    ...
    full_name: "Major Depressive Disorder with Peripartum Onset",
    category: "mood",
    description_for_user:
      "A pattern of significant mood changes during pregnancy or after childbirth that goes beyond typical adjustment. Many parents experience this, and effective support is available.",
    minimum_duration: "2_weeks",
    minimum_duration_display: "At least 2 weeks",
    minimum_symptoms_for_relevance: 4,
    always_recommend_professional: true,
    guide_path: "/learn/conditions/postpartum-depression",
    coping_path: "/learn/coping/postpartum-strategies",
    provider_questions: [
      "Could what I am feeling be postpartum depression?",
      "What treatments are safe during breastfeeding?",
      "How can I get support for peripartum mood changes?",
    ],
    clinical_notes:
      "Based on DSM-5-TR Major Depressive Disorder with Peripartum Onset specifier. ICD-11 6E20.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "MOD_001", weight: 3, role: "core" },
      ...
      { symptom_id: "SLP_001", weight: 2, role: "common" },
      { symptom_id: "ENR_001", weight: 2, role: "common" },
      { symptom_id: "EMR_003", weight: 2, role: "common" },
      { symptom_id: "MOD_004", weight: 2, role: "common" },
      { symptom_id: "ANX_007", weight: 2, role: "common" },
      { symptom_id: "COG_005", weight: 2, role: "common" },
      { symptom_id: "MOD_005", weight: 1, role: "associated" },
    ...
    red_flags: [
      {
        symptom_id: "COG_008",
        note: "Self-harm ideation in peripartum period requires immediate safety assessment",
      },
      {
        symptom_id: "COG_009",
        note: "Suicidal ideation in peripartum period requires immediate crisis intervention",
      },
    ],
  },
  // 34. CPTSD — Complex Post-Traumatic Stress Disorder
  {
    ...
    category: "trauma",
    description_for_user:
      "A pattern that can develop after prolonged or repeated traumatic experiences, especially in childhood. Beyond typical trauma responses, it often includes difficulties with emotional regulation, self-perception, and relationships.",
    minimum_duration: "1_month",
    minimum_duration_display: "Following prolonged trauma",
    minimum_symptoms_for_relevance: 5,
    always_recommend_professional: true,
    guide_path: "/learn/conditions/complex-ptsd",
    coping_path: "/learn/coping/trauma-strategies",
    provider_questions: [
      "Could my experiences be related to complex trauma?",
      "What is the difference between PTSD and Complex PTSD?",
      "What are the best evidence-based treatments for complex trauma?",
    ],
    clinical_notes:
      "Based on ICD-11 criteria for Complex PTSD (6B41). Not a separate diagnosis in DSM-5-TR but recognized clinically.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "COG_007", weight: 3, role: "core" },
      { symptom_id: "PRC_001", weight: 3, role: "core" },
      { symptom_id: "MOD_008", weight: 3, role: "core" },
      { symptom_id: "IDN_001", weight: 3, role: "core" },
      ...
      { symptom_id: "PRC_002", weight: 2, role: "common" },
      { symptom_id: "MOD_003", weight: 1, role: "associated" },
      { symptom_id: "SLP_004", weight: 1, role: "associated" },
      { symptom_id: "CPG_001", weight: 1, role: "associated" },
      { symptom_id: "CPG_004", weight: 1, role: "associated" },
      { symptom_id: "SOC_001", weight: 1, role: "associated" },
      { symptom_id: "ANX_005", weight: 1, role: "associated" },
    ],
    red_flags: [
      { symptom_id: "COG_008", note: "Self-harm ideation requires immediate safety assessment" },
      { symptom_id: "COG_009", note: "Suicidal ideation requires immediate crisis intervention" },
    ],
  },
  // 35. ASD_ACUTE — Acute Stress Disorder
  {
    ...
    category: "trauma",
    description_for_user:
      "An intense stress response that can occur within the first month after a traumatic event. Many people experience this initially, and it often resolves with support, though some may benefit from professional guidance.",
    minimum_duration: "1_week",
    ...
    coping_path: "/learn/coping/trauma-strategies",
    provider_questions: [
      "Is what I am experiencing a normal response to trauma?",
      "Could this develop into PTSD?",
      "What early interventions help after a traumatic event?",
    ],
    clinical_notes: "Based on DSM-5-TR criteria for Acute Stress Disorder (308.3). ICD-11 QE84.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "COG_007", weight: 3, role: "core" },
      { symptom_id: "PRC_001", weight: 3, role: "core" },
      { symptom_id: "PRC_002", weight: 3, role: "core" },
      { symptom_id: "ANX_005", weight: 2, role: "common" },
      { symptom_id: "MOD_009", weight: 2, role: "common" },
      { symptom_id: "SLP_004", weight: 2, role: "common" },
      { symptom_id: "SLP_001", weight: 2, role: "common" },
      { symptom_id: "COG_001", weight: 2, role: "common" },
  ...
  {
    id: "DID",
    name: "Dissociative Identity Patterns",
    full_name: "Dissociative Identity Disorder",
    category: "dissociative",
    description_for_user:
      "A pattern involving the experience of two or more distinct identity states, along with gaps in memory for everyday events. This is often associated with early life trauma and is more common than many people realize.",
    minimum_duration: "1_month",
    minimum_duration_display: "Recurrent experiences",
    minimum_symptoms_for_relevance: 3,
    always_recommend_professional: true,
    guide_path: "/learn/conditions/dissociative-identity",
    coping_path: "/learn/coping/dissociation-strategies",
    provider_questions: [
      "Could my experiences of feeling like different people be related to a dissociative condition?",
      "What kind of specialist works with dissociative disorders?",
      "How is DID assessed and treated?",
    ],
    clinical_notes:
      "Based on DSM-5-TR criteria for Dissociative Identity Disorder (300.14). ICD-11 6B64.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "PRC_002", weight: 3, role: "core" },
      { symptom_id: "COG_004", weight: 3, role: "core" },
      { symptom_id: "IDN_001", weight: 3, role: "core" },
      { symptom_id: "COG_007", weight: 2, role: "common" },
      { symptom_id: "MOD_009", weight: 2, role: "common" },
      { symptom_id: "SLP_004", weight: 2, role: "common" },
  ...
  {
    id: "IED",
    name: "Explosive Anger Patterns",
    full_name: "Intermittent Explosive Disorder",
    category: "stress",
    description_for_user:
      "A pattern of repeated, sudden episodes of impulsive, aggressive, or violent behavior that is out of proportion to the situation. Many people feel remorseful afterward and may benefit from learning about anger management approaches.",
    minimum_duration: "3_months",
    minimum_duration_display: "At least 3 months",
    minimum_symptoms_for_relevance: 2,
    always_recommend_professional: true,
    guide_path: "/learn/conditions/intermittent-explosive",
    coping_path: "/learn/coping/anger-management",
    provider_questions: [
      "Could my anger outbursts indicate intermittent explosive disorder?",
      "What treatments are most effective for impulsive aggression?",
      "Are there medications that help with explosive anger?",
    ],
    clinical_notes:
      "Based on DSM-5-TR criteria for Intermittent Explosive Disorder (312.34). ICD-11 6C73.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "EMR_002", weight: 3, role: "core" },
      { symptom_id: "EMR_001", weight: 3, role: "core" },
      { symptom_id: "ACT_002", weight: 3, role: "core" },
      { symptom_id: "MOD_007", weight: 2, role: "common" },
      { symptom_id: "SOC_002", weight: 2, role: "common" },
      { symptom_id: "MOD_004", weight: 2, role: "common" },
      { symptom_id: "ANX_005", weight: 1, role: "associated" },
      { symptom_id: "ACT_003", weight: 1, role: "associated" },
      { symptom_id: "SOC_007", weight: 1, role: "associated" },
      { symptom_id: "BDY_003", weight: 1, role: "associated" },
    ],
    red_flags: [
      {
        symptom_id: "COG_010",
        note: "Thoughts of harming others require immediate safety assessment",
      },
    ],
  },
  // 38. GRIEF — Normal Grief / Bereavement
  {
    id: "GRIEF",
    name: "Grief Response",
    full_name: "Normal Grief and Bereavement",
    category: "stress",
    description_for_user:
      "A natural emotional response to significant loss. Grief affects everyone differently and there is no single right way to grieve. While painful, most people gradually adjust with time and support.",
    minimum_duration: "2_weeks",
    minimum_duration_display: "Following a loss",
    minimum_symptoms_for_relevance: 2,
    always_recommend_professional: false,
    guide_path: "/learn/conditions/grief",
    coping_path: "/learn/coping/grief-strategies",
    provider_questions: [
      "Is what I am experiencing a normal part of grief?",
      "When should I seek professional support for grief?",
      "What resources can help me through this loss?",
    ],
    clinical_notes:
      "ICD-11 QE62. Normal bereavement is not a mental disorder but can benefit from support.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "MOD_001", weight: 3, role: "core" },
      { symptom_id: "EMR_006", weight: 3, role: "core" },
      { symptom_id: "EMR_003", weight: 3, role: "core" },
      { symptom_id: "SLP_001", weight: 2, role: "common" },
      { symptom_id: "APT_001", weight: 2, role: "common" },
      { symptom_id: "COG_006", weight: 2, role: "common" },
      { symptom_id: "SOC_001", weight: 2, role: "common" },
      { symptom_id: "MOD_009", weight: 1, role: "associated" },
      { symptom_id: "ENR_001", weight: 1, role: "associated" },
      { symptom_id: "COG_001", weight: 1, role: "associated" },
      { symptom_id: "MOD_007", weight: 1, role: "associated" },
    ],
    red_flags: [
      {
        symptom_id: "COG_009",
        note: "Suicidal thoughts during grief require immediate crisis support",
      },
    ],
  },
  // 39. GAM — Gambling Disorder
  {
    ...
    category: "substance",
    description_for_user:
      "A pattern of persistent gambling behavior that leads to significant distress or problems in daily life. Like substance use concerns, this involves difficulty controlling the behavior despite negative consequences.",
    minimum_duration: "1_year",
    minimum_duration_display: "At least 12 months",
    minimum_symptoms_for_relevance: 4,
    always_recommend_professional: true,
    guide_path: "/learn/conditions/gambling-disorder",
    coping_path: "/learn/coping/behavioral-addiction",
    provider_questions: [
      "Could my gambling habits indicate a gambling disorder?",
      "What treatments are available for problem gambling?",
      "Are there support groups specifically for gambling?",
    ],
    clinical_notes: "Based on DSM-5-TR criteria for Gambling Disorder (312.31). ICD-11 6C50.",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "ACT_002", weight: 3, role: "core" },
      { symptom_id: "ACT_005", weight: 3, role: "core" },
      { symptom_id: "ANX_001", weight: 2, role: "common" },
      { symptom_id: "MOD_001", weight: 2, role: "common" },
      { symptom_id: "MOD_004", weight: 2, role: "common" },
      { symptom_id: "SOC_002", weight: 2, role: "common" },
    ...
    red_flags: [
      {
        symptom_id: "COG_009",
        note: "Suicidal thoughts in context of gambling losses require immediate crisis support",
      },
    ],
  },
  ...
  {
    id: "IGD",
    name: "Internet/Gaming Concerns",
    full_name: "Internet Gaming Disorder",
    category: "substance",
    description_for_user:
      "A pattern of persistent gaming or internet use that takes priority over other activities and continues despite negative consequences. This is increasingly recognized as a concern that can significantly affect daily functioning.",
    minimum_duration: "1_year",
    minimum_duration_display: "At least 12 months",
    minimum_symptoms_for_relevance: 5,
    always_recommend_professional: false,
    guide_path: "/learn/conditions/gaming-disorder",
    coping_path: "/learn/coping/behavioral-addiction",
    provider_questions: [
      "Could my gaming or internet use be problematic?",
      "What is the difference between heavy use and a disorder?",
      "What strategies help manage excessive screen time?",
    ],
    clinical_notes: "ICD-11 6C51. DSM-5-TR Section III (conditions for further study).",
    is_active: true,
    version: "1.0.0",
    symptom_mappings: [
      { symptom_id: "CPG_008", weight: 3, role: "core" },
      { symptom_id: "ACT_001", weight: 3, role: "core" },
      { symptom_id: "SOC_001", weight: 2, role: "common" },
      { symptom_id: "SLP_001", weight: 2, role: "common" },
      { symptom_id: "ENR_005", weight: 2, role: "common" },
      { symptom_id: "MOD_007", weight: 2, role: "common" },
      { symptom_id: "SOC_002", weight: 1, role: "associated" },
      { symptom_id: "ENR_001", weight: 1, role: "associated" },
      { symptom_id: "ACT_002", weight: 1, role: "associated" },
      { symptom_id: "CPG_006", weight: 1, role: "associated" },
      { symptom_id: "ANX_005", weight: 1, role: "associated" },
    ],
    red_flags: [],
  },
  ...
  crisisResources: {
    US: [
      ...
      },
      {
        ...
        email: null,
        description: "Free treatment referrals and information 24/7.",
        hours: "24/7",
        languages: ["English", "Spanish"],
        priority: 3,
        condition_specific: null,
    ...
    UK: [
      ...
      },
      {
        ...
        email: null,
        description: "Free, confidential crisis text support.",
        hours: "24/7",
        languages: ["English"],
        priority: 2,
        condition_specific: null,
    ...
    CA: [
      {
        ...
        email: null,
        description: "Canada-wide crisis support service.",
        hours: "24/7",
    ...
    BD: [
      {
        ...
        email: null,
        description: "Emotional support helpline for Bangla speakers.",
        hours: "6pm-10pm BST",
    ...
    DE: [
      {
        ...
        email: null,
        description: "Kostenlose Krisenberatung rund um die Uhr.",
        hours: "24/7",
        languages: ["German"],
        priority: 1,
        condition_specific: null,
    ...
    FR: [
      {
        ...
        email: null,
        description: "Écoute et soutien émotionnel gratuit.",
        hours: "24/7",
        languages: ["French"],
        priority: 1,
        condition_specific: null,
