...
function createAllTestSymptoms(): Symptom[] {
  ...
  return [
    ...
    createTestSymptom({
      ...
      synonyms: ["feeling sad", "down", "depressed mood", "low mood"],
    }),
    createTestSymptom({
      id: "MOD_002",
      domain: "emotional",
      category: "mood",
      name: "Hopelessness",
      synonyms: ["no hope", "feeling hopeless", "despair"],
    }),
    createTestSymptom({
      id: "MOD_003",
      domain: "emotional",
      ...
      synonyms: ["anhedonia", "nothing feels good", "lost interest"],
    }),
    createTestSymptom({
      id: "MOD_004",
      domain: "emotional",
      ...
      synonyms: ["feeling nothing", "numb", "flat affect"],
    }),
    createTestSymptom({
      id: "MOD_005",
      domain: "emotional",
      category: "mood",
      name: "Unexplained crying",
      synonyms: ["crying spells", "tearfulness"],
    }),
    createTestSymptom({
      id: "MOD_006",
      domain: "emotional",
      category: "mood",
      name: "Guilt or excessive self-blame",
      synonyms: ["feeling guilty", "self-blame", "shame"],
    }),
    createTestSymptom({
      id: "MOD_007",
      domain: "emotional",
      ...
      synonyms: ["worthlessness", "feeling worthless", "low confidence"],
    }),
    createTestSymptom({
      id: "MOD_008",
      domain: "emotional",
      category: "mood",
      name: "Emptiness",
      synonyms: ["feeling hollow", "void", "empty inside"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["worrying too much", "constant worry", "anxious thoughts"],
    }),
    createTestSymptom({
      id: "ANX_002",
      domain: "emotional",
      category: "anxiety_fear",
      name: "Panic attacks",
      synonyms: ["panic episode", "sudden fear", "anxiety attack"],
    }),
    createTestSymptom({
      id: "ANX_003",
      domain: "emotional",
      category: "anxiety_fear",
      name: "Fear of specific situations",
      synonyms: ["phobia", "irrational fear", "specific fear"],
    }),
    createTestSymptom({
      id: "ANX_004",
      domain: "emotional",
      category: "anxiety_fear",
      name: "Social anxiety",
      synonyms: ["fear of judgment", "social phobia", "performance anxiety"],
    }),
    createTestSymptom({
      id: "ANX_005",
      domain: "emotional",
      ...
      synonyms: ["hypervigilance", "on guard", "alert", "startle response"],
    }),
    createTestSymptom({
      id: "ANX_006",
      domain: "emotional",
      ...
      synonyms: ["loss of control", "going crazy", "losing grip"],
    }),
    createTestSymptom({
      id: "ANX_007",
      domain: "emotional",
      ...
      synonyms: ["worst case scenario", "doomscrolling", "expecting disaster"],
    }),
    createTestSymptom({
      id: "ANX_008",
      domain: "emotional",
      ...
      synonyms: ["too much", "overwhelm", "cant cope"],
    }),
    ...
    createTestSymptom({
      ...
      name: "Mood swings",
      synonyms: ["emotional ups and downs", "mood changes", "unstable mood"],
    }),
    createTestSymptom({
      id: "EMR_002",
      domain: "emotional",
      category: "emotional_regulation",
      name: "Irritability or anger",
      synonyms: ["easily annoyed", "short temper", "angry", "snapping"],
    }),
    createTestSymptom({
      id: "EMR_003",
      domain: "emotional",
      ...
      synonyms: ["re-experiencing emotions", "triggered feelings", "old feelings returning"],
    }),
    createTestSymptom({
      id: "EMR_004",
      domain: "emotional",
      category: "emotional_regulation",
      name: "Euphoria or unusually elevated mood",
      synonyms: ["extremely happy", "manic energy", "on top of the world"],
      severity_red_flag_threshold: 7,
      severity_red_flag_level: "WATCH",
    }),
    createTestSymptom({
      id: "EMR_005",
      domain: "emotional",
      ...
      synonyms: ["depersonalization", "not real", "out of body"],
    }),
    createTestSymptom({
      id: "EMR_006",
      domain: "emotional",
      category: "emotional_regulation",
      name: "Shame",
      synonyms: ["feeling ashamed", "deep shame", "mortified"],
    }),
    ...
    createTestSymptom({
      id: "BDY_001",
      domain: "physical",
      category: "body_sensations",
      name: "Muscle tension or body aches",
      synonyms: ["tense muscles", "body pain", "stiffness"],
    }),
    createTestSymptom({
      id: "BDY_002",
      domain: "physical",
      category: "body_sensations",
      name: "Headaches",
      synonyms: ["head pain", "tension headache", "migraine"],
    }),
    createTestSymptom({
      id: "BDY_003",
      domain: "physical",
      ...
      synonyms: ["racing heart", "pounding heart", "heart beating fast"],
      severity_red_flag_threshold: 9,
      severity_red_flag_level: "URGENT",
    }),
    createTestSymptom({
      id: "BDY_004",
      domain: "physical",
      ...
      synonyms: ["tight chest", "chest pressure", "constricted chest"],
    }),
    createTestSymptom({
      id: "BDY_005",
      domain: "physical",
      ...
      synonyms: ["cant breathe", "breathless", "difficulty breathing"],
    }),
    createTestSymptom({
      id: "BDY_006",
      domain: "physical",
      category: "body_sensations",
      name: "Dizziness",
      synonyms: ["lightheaded", "vertigo", "woozy"],
      severity_red_flag_threshold: 9,
      severity_red_flag_level: "URGENT",
    }),
    createTestSymptom({
      ...
      synonyms: ["shaky hands", "tremors", "quivering"],
    }),
    createTestSymptom({
      id: "BDY_008",
      domain: "physical",
      ...
      synonyms: ["sweaty palms", "cold sweat", "night sweats"],
    }),
    createTestSymptom({
      id: "BDY_009",
      domain: "physical",
      category: "body_sensations",
      name: "Nausea or stomach problems",
      synonyms: ["upset stomach", "butterflies", "GI distress"],
    }),
    createTestSymptom({
      id: "BDY_010",
      domain: "physical",
      category: "body_sensations",
      name: "Chronic pain without clear cause",
      synonyms: ["unexplained pain", "psychosomatic pain"],
    }),
    ...
    createTestSymptom({
      ...
      category: "sleep",
      name: "Insomnia",
      synonyms: ["cant sleep", "difficulty falling asleep", "sleepless"],
    }),
    createTestSymptom({
      id: "SLP_002",
      domain: "physical",
      category: "sleep",
      name: "Oversleeping",
      synonyms: ["sleeping too much", "hypersomnia", "excessive sleep"],
    }),
    createTestSymptom({
      id: "SLP_003",
      domain: "physical",
      ...
      synonyms: ["waking up at night", "broken sleep", "fragmented sleep"],
    }),
    createTestSymptom({
      id: "SLP_004",
      domain: "physical",
      category: "sleep",
      name: "Nightmares",
      synonyms: ["bad dreams", "night terrors", "disturbing dreams"],
    }),
    createTestSymptom({
      id: "SLP_005",
      domain: "physical",
      ...
      synonyms: ["tired after sleeping", "poor sleep quality"],
    }),
    ...
    createTestSymptom({
      id: "APT_001",
      domain: "physical",
      category: "appetite_weight",
      name: "Loss of appetite",
      synonyms: ["not hungry", "no appetite", "eating less"],
    }),
    createTestSymptom({
      id: "APT_002",
      domain: "physical",
      ...
      synonyms: ["overeating", "eating more", "always hungry"],
    }),
    createTestSymptom({
      id: "APT_003",
      domain: "physical",
      ...
      synonyms: ["weight gain", "weight loss", "body changes"],
    }),
    createTestSymptom({
      id: "APT_004",
      domain: "physical",
      category: "appetite_weight",
      name: "Distorted relationship with food",
      synonyms: ["food anxiety", "food obsession", "disordered eating"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["tired", "exhausted", "no energy", "drained"],
    }),
    createTestSymptom({
      id: "ENR_002",
      domain: "physical",
      category: "energy",
      name: "Restlessness",
      synonyms: ["cant sit still", "fidgety", "agitated"],
    }),
    createTestSymptom({
      id: "ENR_003",
      domain: "physical",
      category: "energy",
      name: "Psychomotor slowing",
      synonyms: ["moving slowly", "sluggish", "slowed down"],
    }),
    createTestSymptom({
      id: "ENR_004",
      domain: "physical",
      ...
      synonyms: ["low sex drive", "sexual changes"],
    }),
    createTestSymptom({
      id: "ENR_005",
      domain: "physical",
      ...
      synonyms: ["burnout fatigue", "completely drained", "bone-tired"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["cant focus", "distracted", "attention problems"],
    }),
    createTestSymptom({
      id: "COG_002",
      domain: "cognitive",
      ...
      synonyms: ["mind racing", "thoughts wont stop", "mental overload"],
    }),
    createTestSymptom({
      id: "COG_003",
      domain: "cognitive",
      category: "cognition",
      name: "Brain fog",
      synonyms: ["mental confusion", "foggy thinking", "unclear mind"],
    }),
    createTestSymptom({
      id: "COG_004",
      domain: "cognitive",
      ...
      synonyms: ["forgetful", "cant remember", "memory lapses"],
    }),
    createTestSymptom({
      id: "COG_005",
      domain: "cognitive",
      ...
      synonyms: ["unwanted thoughts", "obsessive thoughts", "disturbing thoughts"],
    }),
    createTestSymptom({
      id: "COG_006",
      domain: "cognitive",
      category: "cognition",
      name: "Indecisiveness",
      synonyms: ["cant make decisions", "paralyzed by choices", "decision fatigue"],
    }),
    createTestSymptom({
      id: "COG_007",
      domain: "cognitive",
      ...
      synonyms: ["rumination", "inner critic", "self-criticism"],
    }),
    createTestSymptom({
      id: "COG_008",
      domain: "cognitive",
      ...
      synonyms: ["hurting myself", "self-injury thoughts"],
      is_red_flag: true,
      red_flag_level: "CRISIS",
    }),
    createTestSymptom({
      id: "COG_009",
      domain: "cognitive",
      ...
      synonyms: ["wanting to die", "suicidal ideation", "ending life"],
      is_red_flag: true,
      red_flag_level: "CRISIS",
    }),
    createTestSymptom({
      ...
      domain: "cognitive",
      category: "cognition",
      name: "Thoughts of harming others",
      synonyms: ["violent thoughts", "hurting someone"],
      is_red_flag: true,
      red_flag_level: "CRISIS",
    }),
    ...
    createTestSymptom({
      ...
      category: "perception",
      name: "Derealization",
      synonyms: ["world feels unreal", "dreamlike state", "nothing seems real"],
    }),
    createTestSymptom({
      id: "PRC_002",
      domain: "cognitive",
      ...
      synonyms: ["detached from self", "watching from outside", "not real"],
    }),
    createTestSymptom({
      id: "PRC_003",
      domain: "cognitive",
      ...
      synonyms: ["seeing things", "visual hallucinations"],
      severity_red_flag_threshold: 7,
      severity_red_flag_level: "URGENT",
    }),
    createTestSymptom({
      ...
      domain: "cognitive",
      category: "perception",
      name: "Hearing voices or sounds",
      synonyms: ["auditory hallucinations", "hearing things"],
      is_red_flag: true,
    ...
    createTestSymptom({
      ...
      synonyms: ["body dysmorphia", "body perception", "dont like body"],
    }),
    createTestSymptom({
      id: "PRC_006",
      domain: "cognitive",
      category: "perception",
      name: "Paranoid thinking",
      synonyms: ["paranoia", "feeling watched", "people are against me"],
      severity_red_flag_threshold: 8,
      severity_red_flag_level: "URGENT",
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["isolation", "avoiding people", "staying home"],
    }),
    createTestSymptom({
      id: "SOC_002",
      domain: "behavioral",
      category: "social",
      name: "Avoiding social situations",
      synonyms: ["social avoidance", "skipping events"],
    }),
    createTestSymptom({
      id: "SOC_003",
      domain: "behavioral",
      category: "social",
      name: "Difficulty maintaining relationships",
      synonyms: ["relationship problems", "pushing people away"],
    }),
    createTestSymptom({
      id: "SOC_004",
      domain: "behavioral",
      category: "social",
      name: "Reduced speech",
      synonyms: ["not talking", "quiet", "withdrawn communication"],
    }),
    createTestSymptom({
      id: "SOC_005",
      domain: "behavioral",
      category: "social",
      name: "Dependence on others",
      synonyms: ["clingy", "needing reassurance", "codependent"],
    }),
    createTestSymptom({
      id: "SOC_006",
      domain: "behavioral",
      category: "social",
      name: "Conflict in relationships",
      synonyms: ["fighting", "arguments", "aggressive interactions"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["trigger avoidance", "avoiding reminders"],
    }),
    createTestSymptom({
      id: "CPG_002",
      domain: "behavioral",
      category: "coping",
      name: "Compulsive or ritualistic behaviors",
      synonyms: ["rituals", "compulsions", "repetitive behaviors"],
    }),
    createTestSymptom({
      id: "CPG_003",
      domain: "behavioral",
      category: "coping",
      name: "Substance use to cope",
      synonyms: ["drinking to cope", "drug use", "self-medicating"],
      severity_red_flag_threshold: 8,
      severity_red_flag_level: "URGENT",
    }),
    createTestSymptom({
      ...
      synonyms: ["cutting", "self-injury", "hurting oneself"],
      is_red_flag: true,
      red_flag_level: "CRISIS",
    }),
    createTestSymptom({
      ...
      synonyms: ["binge eating", "eating too much at once", "uncontrolled eating"],
    }),
    createTestSymptom({
      id: "CPG_006",
      domain: "behavioral",
      category: "coping",
      name: "Restricting food intake",
      synonyms: ["not eating", "food restriction", "skipping meals"],
    }),
    createTestSymptom({
      id: "CPG_007",
      domain: "behavioral",
      category: "coping",
      name: "Excessive checking or reassurance seeking",
      synonyms: ["double-checking", "seeking reassurance", "need to verify"],
    }),
    createTestSymptom({
      id: "CPG_008",
      domain: "behavioral",
      category: "coping",
      name: "Hoarding behaviors",
      synonyms: ["collecting things", "cant throw away", "accumulating"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["putting things off", "avoidance", "delaying tasks"],
    }),
    createTestSymptom({
      id: "ACT_002",
      domain: "behavioral",
      ...
      synonyms: ["letting things slide", "not doing tasks", "ignoring duties"],
    }),
    createTestSymptom({
      id: "ACT_003",
      domain: "behavioral",
      category: "activity_level",
      name: "Difficulty maintaining routines",
      synonyms: ["no routine", "inconsistent habits", "disorganized"],
    }),
    createTestSymptom({
      id: "ACT_004",
      domain: "behavioral",
      ...
      synonyms: ["acting without thinking", "impulsivity", "rash choices"],
    }),
    createTestSymptom({
      id: "ACT_005",
      domain: "behavioral",
      ...
      synonyms: ["reckless behavior", "dangerous activities"],
      severity_red_flag_threshold: 8,
      severity_red_flag_level: "WATCH",
    }),
    createTestSymptom({
      ...
      domain: "behavioral",
      category: "activity_level",
      name: "Excessive working or perfectionism",
      synonyms: ["workaholic", "perfectionist", "overworking"],
    }),
    ...
    createTestSymptom({
      id: "IDN_001",
      domain: "behavioral",
      category: "identity_self_image",
      name: "Unstable sense of identity",
      synonyms: ["identity confusion", "who am I", "shifting self"],
    }),
    createTestSymptom({
      id: "IDN_002",
      domain: "behavioral",
      ...
      synonyms: ["abandonment anxiety", "fear of being left", "clingy"],
    }),
    createTestSymptom({
      id: "IDN_003",
      domain: "behavioral",
      category: "identity_self_image",
      name: "Chronic feelings of inadequacy",
      synonyms: ["not good enough", "inadequate", "inferior"],
    }),
    createTestSymptom({
      id: "IDN_004",
      domain: "behavioral",
      category: "identity_self_image",
      name: "Splitting or black-and-white thinking",
      synonyms: ["all or nothing", "black and white", "idealization"],
    }),
    ...
    createTestSymptom({
      id: "SOM_001",
      domain: "physical",
      category: "somatic_health",
      name: "Excessive worry about health or illness",
      synonyms: ["health anxiety", "hypochondria", "illness worry"],
    }),
    createTestSymptom({
      id: "SOM_002",
      domain: "physical",
      category: "somatic_health",
      name: "Persistent physical symptoms causing distress",
      synonyms: ["somatic symptoms", "unexplained symptoms", "body distress"],
    }),
    createTestSymptom({
      id: "SOM_003",
      domain: "physical",
      category: "somatic_health",
      name: "Frequent medical visits or health checking",
      synonyms: ["doctor shopping", "health checking", "medical reassurance"],
    }),
    ...
    createTestSymptom({
      ...
      domain: "behavioral",
      category: "coping",
      name: "Purging behaviors",
      synonyms: ["purging", "self-induced vomiting", "laxative misuse"],
      severity_red_flag_threshold: 6,
      severity_red_flag_level: "URGENT",
    }),
    createTestSymptom({
      id: "CPG_010",
      domain: "behavioral",
      category: "coping",
      name: "Excessive exercise to compensate for eating",
      synonyms: ["compulsive exercise", "exercise purging", "over-exercising"],
    }),
    createTestSymptom({
      id: "CPG_011",
      domain: "behavioral",
      category: "coping",
      name: "Collecting or difficulty discarding possessions",
      synonyms: ["accumulating", "collecting compulsion", "keeping everything"],
    }),
    createTestSymptom({
      id: "CPG_012",
      domain: "behavioral",
      category: "coping",
      name: "Distress when discarding possessions",
      synonyms: ["discard anxiety", "throwing away distress", "letting go anxiety"],
    }),
    ...
    createTestSymptom({
      ...
      domain: "cognitive",
      category: "perception",
      name: "Delusions or strongly held false beliefs",
      synonyms: ["delusional thinking", "false beliefs", "fixed beliefs"],
      is_red_flag: true,
      red_flag_level: "URGENT",
    }),
    ...
    createTestSymptom({
      ...
      domain: "behavioral",
      category: "social",
      name: "Difficulty understanding social cues",
      synonyms: ["social cue difficulty", "reading people", "social blindness"],
    }),
    createTestSymptom({
      id: "SOC_008",
      domain: "behavioral",
      category: "social",
      name: "Intense but unstable relationships",
      synonyms: ["turbulent relationships", "unstable bonds", "love-hate"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["fear of separation", "separation distress", "attachment anxiety"],
    }),
    createTestSymptom({
      id: "ANX_010",
      domain: "emotional",
      category: "anxiety_fear",
      name: "Fear of contamination or germs",
      synonyms: ["germophobia", "contamination fear", "mysophobia"],
    }),
    ...
    createTestSymptom({
      ...
      domain: "emotional",
      category: "mood",
      name: "Intense yearning or longing for deceased",
      synonyms: ["grief yearning", "missing deceased", "longing for loved one"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["thought disorder", "incoherent speech", "disorganized thoughts"],
      severity_red_flag_threshold: 7,
      severity_red_flag_level: "URGENT",
    }),
    ...
    createTestSymptom({
      ...
      domain: "behavioral",
      category: "activity_level",
      name: "Repetitive behaviors or restricted interests",
      synonyms: ["restricted interests", "repetitive patterns", "special interests"],
    }),
    createTestSymptom({
      id: "ACT_008",
      domain: "behavioral",
      ...
      synonyms: ["sensory overload", "hypersensitivity", "sensory issues"],
    }),
    ...
    createTestSymptom({
      ...
      domain: "physical",
      category: "energy",
      name: "Seasonal energy and mood changes",
      synonyms: ["seasonal changes", "winter blues", "seasonal pattern"],
    }),
    ...
    createTestSymptom({
      ...
      category: "identity_self_image",
      name: "Grandiosity",
      synonyms: ["inflated self-importance", "superiority", "grandiose beliefs"],
    }),
    createTestSymptom({
      id: "IDN_006",
      domain: "behavioral",
      ...
      synonyms: ["empathy deficit", "inability to empathize", "callousness"],
    }),
    createTestSymptom({
      id: "IDN_007",
      domain: "behavioral",
      ...
      synonyms: ["attention seeking", "validation seeking", "admiration craving"],
    }),
    createTestSymptom({
      id: "IDN_008",
      domain: "behavioral",
      category: "identity_self_image",
      name: "Submissiveness",
      synonyms: ["excessive compliance", "inability to disagree", "deferential"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["persistent void", "emotional vacuum", "inner emptiness"],
    }),
    createTestSymptom({
      id: "EMR_008",
      domain: "emotional",
      category: "emotional_regulation",
      name: "Inability to conform to social norms",
      synonyms: ["norm violation", "rule breaking", "disregard for rules"],
    }),
    ...
    createTestSymptom({
      ...
      category: "mood",
      name: "Hypomania",
      synonyms: ["mild mania", "elevated mood episodes", "subthreshold mania"],
    }),
    createTestSymptom({
      id: "MOD_011",
      domain: "emotional",
      category: "mood",
      name: "Envy",
      synonyms: ["jealousy", "envious feelings", "covetousness"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["difficulty regulating emotions", "emotional instability", "affect dysregulation"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["recklessness", "dangerous choices", "disregard for safety"],
      severity_red_flag_threshold: 8,
      severity_red_flag_level: "WATCH",
    }),
    createTestSymptom({
      ...
      domain: "behavioral",
      category: "activity_level",
      name: "Lying or manipulation",
      synonyms: ["deceitfulness", "manipulative behavior", "pathological lying"],
    }),
    ...
    createTestSymptom({
      ...
      domain: "cognitive",
      category: "perception",
      name: "Identity switching",
      synonyms: ["alter switching", "identity shifts", "personality switching"],
      is_red_flag: true,
      red_flag_level: "URGENT",
    }),
    createTestSymptom({
      ...
      synonyms: ["memory gaps", "lost time", "blackouts"],
      severity_red_flag_threshold: 7,
      severity_red_flag_level: "URGENT",
    }),
    createTestSymptom({
      ...
      domain: "cognitive",
      category: "perception",
      name: "Detachment from surroundings",
      synonyms: ["environmental detachment", "feeling disconnected", "surreal surroundings"],
    }),
    ...
    createTestSymptom({
      ...
      category: "coping",
      name: "Hair pulling",
      synonyms: ["trichotillomania", "pulling hair out", "hair pulling urge"],
    }),
    createTestSymptom({
      id: "CPG_014",
      domain: "behavioral",
      category: "coping",
      name: "Skin picking",
      synonyms: ["excoriation", "picking at skin", "skin picking urge"],
    }),
    createTestSymptom({
      id: "CPG_015",
      domain: "behavioral",
      category: "coping",
      name: "Explosive anger episodes",
      synonyms: ["rage outbursts", "explosive outbursts", "uncontrollable anger"],
      severity_red_flag_threshold: 8,
      severity_red_flag_level: "WATCH",
    }),
    ...
    createTestSymptom({
      ...
      domain: "behavioral",
      category: "social",
      name: "Emotional detachment from relationships",
      synonyms: ["relational indifference", "social indifference", "interpersonal detachment"],
    }),
    ...
    createTestSymptom({
      ...
      synonyms: ["daytime drowsiness", "constant sleepiness", "hypersomnia"],
      severity_red_flag_threshold: 8,
      severity_red_flag_level: "WATCH",
    }),
    createTestSymptom({
      ...
      category: "sleep",
      name: "Sleep inertia",
      synonyms: ["difficulty waking", "groggy upon waking", "sleep drunkenness"],
    }),
    createTestSymptom({
      id: "SLP_008",
      domain: "physical",
      ...
      synonyms: ["sleeping too long", "extended sleep", "prolonged sleep"],
    }),
    ...
    createTestSymptom({
      ...
      domain: "physical",
      category: "appetite_weight",
      name: "Sensory-based food avoidance",
      synonyms: ["texture aversion", "food texture sensitivity", "sensory food issues"],
      severity_red_flag_threshold: 7,
      severity_red_flag_level: "WATCH",
    }),
    createTestSymptom({
      ...
      domain: "physical",
      category: "appetite_weight",
      name: "Fear of aversive food consequences",
      synonyms: ["choking fear", "fear of vomiting from food", "food phobia"],
      severity_red_flag_threshold: 7,
      severity_red_flag_level: "WATCH",
    }),
  ];
...
function createAllTestConditions(): ConditionWithMappings[] {
  return [
    // 1. MDE — Major Depressive Episode (23 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Major Depressive Disorder (296.xx). Requires 5+ symptoms during the same 2-week period with at least one being depressed mood or loss of interest.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        // Core (weight 3)
    ...
    // 2. PDD — Persistent Depressive Disorder (15 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Persistent Depressive Disorder (300.4). Requires depressed mood for most of the day, more days than not, for at least 2 years.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        { symptom_id: "MOD_001", weight: 3, role: "core" },
    ...
    // 3. GAD — Generalized Anxiety Disorder (18 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Generalized Anxiety Disorder (300.02). Requires excessive anxiety and worry for more days than not, for at least 6 months.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 4. PD — Panic Disorder (14 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Panic Disorder (300.01). Requires recurrent unexpected panic attacks with at least 1 month of concern about additional attacks.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 5. SAD — Social Anxiety Disorder (14 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Social Anxiety Disorder (300.23). Requires marked fear or anxiety about social situations for at least 6 months.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 6. PTSD — Post-Traumatic Stress Disorder (20 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for PTSD (309.81). Requires exposure to traumatic event and symptoms in four clusters: intrusion, avoidance, cognition/mood changes, arousal/reactivity.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 7. OCD — Obsessive-Compulsive Disorder (13 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for OCD (300.3). Requires presence of obsessions, compulsions, or both that are time-consuming or cause significant distress.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        { symptom_id: "COG_005", weight: 3, role: "core" },
    ...
    // 8. BIP — Bipolar Disorder (20 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Bipolar I/II Disorder (296.xx). Manic episode requires distinct period of elevated/irritable mood lasting at least 1 week.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 9. ADHD — Attention-Deficit/Hyperactivity Disorder (17 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for ADHD (314.0x). Requires several symptoms present before age 12, persisting for at least 6 months, in two or more settings.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 10. BUR — Burnout Syndrome (18 mappings)
    {
      ...
      clinical_notes:
        "Based on ICD-11 definition of Burnout (QD85). WHO classifies it as an occupational phenomenon with three dimensions: exhaustion, cynicism, reduced efficacy.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        { symptom_id: "ENR_001", weight: 3, role: "core" },
    ...
    // 11. INS — Insomnia Disorder (13 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Insomnia Disorder (780.52). Requires sleep difficulty at least 3 nights per week for at least 3 months despite adequate sleep opportunity.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        { symptom_id: "SLP_001", weight: 3, role: "core" },
    ...
    // 12. BED — Binge Eating Disorder (13 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Binge Eating Disorder (307.51). Requires binge episodes at least once a week for 3 months, not followed by purging.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 13. AN — Anorexia Nervosa (14 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Anorexia Nervosa (307.1). Requires restriction of energy intake, intense fear of gaining weight, disturbance in body image.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 14. SUD — Substance Use Concern (15 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Substance Use Disorders, generalized framework. Severity determined by number of criteria met: mild (2-3), moderate (4-5), severe (6+).",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 15. AGO — Agoraphobia (13 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Agoraphobia (300.22). Requires marked fear/anxiety about 2+ situations for at least 6 months.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
    ...
    // 16. ADJ — Adjustment Disorder (17 mappings)
    {
      ...
      clinical_notes:
        "Based on DSM-5 criteria for Adjustment Disorders (309.x). Symptoms develop within 3 months of an identifiable stressor.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        { symptom_id: "ANX_008", weight: 3, role: "core" },
    ...
    // 36. CPTSD — Complex PTSD (12 mappings)
    {
      ...
      clinical_notes:
        "ICD-11 6B41. Not in DSM-5-TR as separate diagnosis but recognized clinically. Requires PTSD symptoms plus disturbances in self-organization.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        // Core (weight 3)
    ...
    // 37. DID — Dissociative Identity Disorder (6 mappings)
    {
      ...
      clinical_notes:
        "DSM-5-TR 300.14. ICD-11 6B64. Requires disruption of identity with two or more distinct personality states.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        // Core (weight 3)
      ...
      red_flags: [
        {
          symptom_id: "PRC_008",
          note: "Identity switching requires urgent specialized evaluation",
        },
      ],
    },
    ...
    // 43. HYPER — Hypersomnolence Disorder (8 mappings)
    {
      ...
      clinical_notes:
        "DSM-5-TR 780.54. ICD-11 7A20. Requires excessive sleepiness at least 3 times/week for 3+ months.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        // Core (weight 3)
    ...
    // 44. ARFID — Avoidant/Restrictive Food Intake Disorder (7 mappings)
    {
      ...
      clinical_notes:
        "DSM-5-TR 307.59. ICD-11 6B83. Distinguished from AN by absence of body image disturbance.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        // Core (weight 3)
    ...
    // 45. CYC — Cyclothymic Disorder (10 mappings)
    {
      ...
      clinical_notes:
        "DSM-5-TR 301.13. ICD-11 6A62. Chronic fluctuating mood for at least 2 years with numerous hypomanic and depressive periods.",
      is_active: true,
      version: "1.0.0",
      symptom_mappings: [
        // Core (weight 3)
  ...
  return {
    US: [
      {
        ...
        email: null,
        description:
          "Free, confidential support for people in distress. Available 24/7 via call or text.",
        hours: "24/7",
      ...
      },
      {
        ...
        email: null,
        description:
          "Free crisis counseling via text message. Trained crisis counselors available 24/7.",
        hours: "24/7",
        languages: ["English", "Spanish"],
        priority: 2,
        condition_specific: null,
    ...
    GB: [
      {
        ...
        description:
          "Emotional support for anyone in distress. Free to call, 24 hours a day, 365 days a year.",
        hours: "24/7",
        languages: ["English"],
        priority: 1,
        condition_specific: null,
    ...
    DEFAULT: [
      ...
      },
      {
        ...
        email: null,
        description:
          "International Association for Suicide Prevention — global directory of crisis centers.",
        hours: "Varies by location",
        languages: ["Multiple"],
        priority: 2,
        condition_specific: null,
